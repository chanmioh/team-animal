...
export default function Home() {
  ...
  return (
    <div>
      ...
      {/* Credits */}
      <span className="fixed bottom-4 w-screen text-center text-xs mt-6">Made for Chewy Diversity Hackathon 2023 by team "PawCare".</span>
    </div>
  );
}
